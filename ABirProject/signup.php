          ...
          <div class="card p-7">
            ...
            <div class="app-brand justify-content-center mt-5">
              <a href="index.html" class="app-brand-link gap-3">
                ...
                <span class="app-brand-text demo text-heading fw-semibold">User Panel !</span>
              </a>
            </div>
            <!-- /Logo -->
            <div class="card-body mt-1">
              <h4 class="mb-1">Welcome to E-Banking ! 🚀</h4>
              <p class="mb-5">Make your app management easy and fun!</p>

              <form id="formAuthentication" class="mb-5" action="register.php" method="POST">
                ...
                <button name="submit" class="btn btn-primary d-grid w-100 mb-5">Sign up</button>
              </form>
